	...
	<view>
		...
		<view class="listcurrently flex-col bb" @click="intoParkingLotDetail">
			...
			<view class="spaces flex flex-row-between">
				...
				<view class="flex">
					<image src="../../static/images/man@2x.png" mode="" style="width: 32rpx; height: 32rpx" /><!--../../static/images/man@2x.png-->
			...
			<view class="price flex flex-col-center flex-row-between">
				...
				<view class="flex distance">
					<image src="../../static/images/daohang@2x.png" mode="" style="width: 32rpx; height: 32rpx"></image><!-- ../../static/images/导航@2x.png -->
