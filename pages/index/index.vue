<template>
	...
	<view>
		...
		<view v-if="navIndex == 2" class="flex-col flex-col-center">
			...
			<view style="font-size: 24rpx;opacity: .7;margin-top: 32rpx;">请前往各大应用市场下载 卓越网络app 体验</view>
		</view>
...
<style lang="scss">
	...
	.bg {
		width: 100vw;
		height: 670rpx;
		background: linear-gradient(360deg, #fff2d97f 0%, #e8921a 100%);
