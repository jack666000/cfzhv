<template>
	<view>
		...
		<view class="scheduleBox flex">
			<view class="one" v-if="show">{{getPercent(chargeInfo.contents.chargingUseLog.planChargingKwh)}}</view>
			<view class="two">%</view>
		</view>
		<view class="estimatedTime" v-if="show">预计还需要
		...
		<view class="flex moneyBox flex-col-center" style="margin-top: 108rpx;">
			<view class="title">充电时间</view>
			<view class="num" v-if="show">{{chargeInfo.contents.chargingedTime / 60000}}</view>
			<view class="unit">分钟</view>
		</view>

		<view class="flex moneyBox flex-col-center" style="margin-top: 66rpx;">
		...
		<view class="endChargingBox" @click="stopCharge">
			结束充电
		</view>
		<!-- 
